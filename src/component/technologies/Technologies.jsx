import { Box, Button, Container, Grid, Stack, Typography, Modal, IconButton, List, ListItem, ListItemIcon, ListItemText } from '@mui/material'
...
export default function Technologies() {
    ...
    return (
        <>
                ...
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        ...
                        <Typography sx={{ color: "var(--color-dark2)" }}>
                            <Box >
                                <Typography>  dolor sit amet consectetur, adipisicing elit. Vel quasi quod sint esse eius quo quae veritatis laborum officiis ducimus! </Typography>
            ...
            <Container sx={{ py: 5 }}>
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={12} md={3} lg={3} xl={3} sx={{ display: { md: "none", xs: "inline-block" } }}
                    >
                        <Box>
