                ...
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        ...
                        <Box data-aos="fade-up">
                            ...
                            <Typography sx={{ fontSize: "16px", color: "var(--color-dark)" }} >
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        ...
                        <Divider
                            sx={{ mt: 2, border: '1px dotted var(--color-blue)', }} />
                    </Grid>
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Box></Box>
                    </Grid>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6}>
                        <Box data-aos="fade-down">
                            <Typography variant="h5" sx={{ fontWeight: 600, }}>IT Sales Manager</Typography>
                            <Box sx={{ justifyContent: "center", display: "flex", py: 2 }}>
                                <img src={react} alt="" />
                            </Box>
                        </Box>
                        <Box data-aos="fade-up">
                            <Typography sx={{ fontSize: "16px", color: "var(--color-dark)" }}>
                                We're looking for an IT Sales Manager with at least 2 years of experience. If you're passionate about technology, enjoy building client relationships, and have a proven track record in sales, we want to hear from you! Join our dynamic team and take the next step in your career. Apply now to be part of our exciting journey in the ever-evolving IT industry.
                            </Typography>
                            <Box mt={2}>
                                <Button
                                    onClick={handleOpen}
