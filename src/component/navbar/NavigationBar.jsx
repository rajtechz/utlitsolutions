      ...
      <HideOnScroll>
        <nav className=" px-8 py-4 flex justify-between items-cente sticky top-0 z-50 shadow-2xl bg-white">
          ...
          <ul className={`hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6 ${isNavbarActive ? 'active-navbar' : ''}`}>
            ...
            <li> <Button onClick={handleScrollToTop} className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" to="/service" component={Link}>Service</Button></li>
            <li> <Button onClick={handleScrollToTop} className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" to="/technologies" component={Link}>Technologies</Button></li>
            <li> <Button onClick={handleScrollToTop} className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" to="/aboutus" component={Link} >About us </Button></li>
            <li> <Button onClick={handleScrollToTop} className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" to="/career" component={Link}>Career</Button></li>
          </ul>
            ...
            <List gap={2} style={{ padding: "10px" }}>
              ...
              <ListItem sx={{ padding: "0px", }}>
                ...
                >
                  ...
                  <ListItemText style={{ margin: " 10px 10px 10px -10px" }} >
                    <Typography className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" style={{ fontSize: "1.05rem", fontWeight: "500" }} >Service</Typography>
                  </ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem sx={{ padding: "0px", }}>
                <ListItemButton
                  ...
                  <ListItemText style={{ margin: " 10px 10px 10px -10px" }} >
                    <Typography className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" style={{ fontSize: "1.05rem", fontWeight: "500" }} >Technologies</Typography>
                  </ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem sx={{ padding: "0px", }}>
                <ListItemButton
                  ...
                  <ListItemText style={{ margin: " 10px 10px 10px -10px" }} >
                    <Typography className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" style={{ fontSize: "1.05rem", fontWeight: "500" }} >About us </Typography>
                  </ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem sx={{ padding: "0px", }}>
                <ListItemButton
                  ...
                  <ListItemText style={{ margin: " 10px 10px 10px -10px" }} >
                    <Typography className='text-md text-gray-400  nav-link cursor-pointer' color="inherit" style={{ fontSize: "1.05rem", fontWeight: "500" }} >Career</Typography>
                  </ListItemText>
                </ListItemButton>
              </ListItem>
              <ListItem >
